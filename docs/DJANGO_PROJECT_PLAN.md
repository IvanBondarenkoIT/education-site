# План создания Django сайта "Dim Kava"

## Контекст проекта
Создание образовательного сайта на Django для компании "Dim Kava" на основе сохраненных HTML страниц в папке `source`. 

### Исходные данные
- **Папка source** содержит HTML файлы:
  - `Главная страница.html`
  - `Добро пожаловать в команду Dim Kava_files/saved_resource.html` (таблица с 33 бизнес-ценностями)
